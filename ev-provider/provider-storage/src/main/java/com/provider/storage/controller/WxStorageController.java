package com.provider.storage.controller;


import com.ev.cloud.db.domain.LitemallStorage;
import com.ev.cloud.db.service.LitemallStorageService;
import com.ev.cloud.db.util.JsonResult;
import com.ev.common.utils.CharUtil;
import com.ev.common.core.storage.StorageService;
...
public class WxStorageController {
    ...
    public JsonResult upload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        return JsonResult.ok(litemallStorage);
    }
