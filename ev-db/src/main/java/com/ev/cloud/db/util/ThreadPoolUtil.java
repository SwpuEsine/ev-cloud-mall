...
import com.ev.cloud.db.thread.NamedThreadFactory;
...
public class ThreadPoolUtil {
    ...
    public static ThreadPoolExecutor setThreadName(String prefix){
        pool.setThreadFactory(new NamedThreadFactory(prefix));
        return pool;
    }
