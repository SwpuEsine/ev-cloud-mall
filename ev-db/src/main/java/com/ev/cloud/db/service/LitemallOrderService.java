...
import com.ev.cloud.db.domain.LitemallOrderExample;
import com.ev.cloud.db.mapper.LitemallOrderMapper;
import com.ev.cloud.db.mapper.OrderMapper;
...
public class LitemallOrderService {
    ...
    public List<LitemallOrder> querySelective(Integer userId, String orderSn, List<Short> orderStatusArray, Integer page, Integer limit, String sort, String order,String areaCode) {
        LitemallOrderExample example = new LitemallOrderExample();
        ...
        if (!StringUtils.isEmpty(areaCode)) {
            criteria.andOrderAreaCodeEquals(areaCode);
        }
        criteria.andDeletedEqualTo(false);
