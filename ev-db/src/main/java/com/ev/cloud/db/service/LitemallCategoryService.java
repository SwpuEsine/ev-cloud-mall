...
import com.ev.cloud.db.domain.LitemallCategoryExample;
import com.ev.cloud.db.mapper.LitemallCategoryMapper;
...
public class LitemallCategoryService {
    ...
    public List<LitemallCategory> queryChannelLimit(int offset, int limit) {
        LitemallCategoryExample example = new LitemallCategoryExample();
        example.or().andLevelEqualTo("L1").andDeletedEqualTo(false);
        PageHelper.startPage(offset, limit);
