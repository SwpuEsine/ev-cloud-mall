package com.ev.common.base.constant;
...
public class SystemConfig {
    ...
    public final static String LITEMALL_WX_INDEX_CHANNEL = "litemall_wx_index_channel";
    ...
    public static Integer getChannelLimit() {
        return getConfigInt(LITEMALL_WX_INDEX_CHANNEL);
    }
